...
- **Myggespray** og hovedtørklæder, særligt nord for Trondheim om aftenen.
...
- Nord (Lofoten, Tromsø): 10–16°C, midnatssol borte, men stadig lyst til 23.

## På stedet

### Hvor starter vi?

Det afhænger af om I vil prioritere fjorde eller Lofoten — der er ikke tid til begge på 3 uger.

- **Fjord-rute (Bergen → Trondheim):** ind i Bergen, lej camper, op gennem Hardanger og Sogn, over Trollstigen, ud ved Trondheim. Fly hjem.
- **Lofoten-rute (Bodø → Tromsø):** ind i Trondheim eller Bodø, op langs kysten, ind i Lofoten i en uge, ud via Tromsø.

Hvis tvivl: **fjord-ruten** har mere variation og er nemmere logistik med små børn.

### Top oplevelser for Olli (~9) og Luca (~7)

- **Geirangerfjorden med rib-båd** — vandet sprøjter, vandfaldene er lige der. Husk regntøj.
- **Trolltunga er ude** — for langt og farligt for 7-årige. **Trollstigen kør-op** giver samme "wow" uden vandring.
- **Vøringsfossen** — gangbroen ud over vandfaldet skræmmer voksne, ikke børn.
- **Norsk Folkemuseum (Oslo)** — stavkirker og gamle gårde med trolde-temaer.
...
| Type | Pris pr. person (DKK) |
|---|---|
| Pølse på en bensinstation | 35–55 |
| Café-frokost (sandwich + drik) | 130–180 |
| Familie-restaurant aften | 250–400 |
| Indkøb til camper-aften | 70–120 |
...
- Tøm gråvand kun ved tømningsstationer (campingpladser, bensinstationer).
...
- **Sygesikring**: hvis nogen skal tilses, søg "**legevakt**" — det er den lokale skadestue, gratis for nordboere.
- Olli kan begynde at kede sig i bilen efter 2 timer. Planlæg stop hver 90 min.
- **Gratis offentlige toiletter** er sjældne — brug bensinstationer.

## Næste skridt

> Dette er en første draft. Rejseguiden uddyber denne side senere med konkrete bookbare stop, præcise camper-leje-anbefalinger og et 21-dages dag-for-dag forslag.
